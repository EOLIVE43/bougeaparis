    ...
    <div class="container">
        ...
        <div class="site-footer__cols">
            ...
            <div class="site-footer__col">
                <h2 class="site-footer__heading">Decouvrir</h2>
            ...
            <div class="site-footer__col">
                <h2 class="site-footer__heading">A propos</h2>
                <ul class="site-footer__list">
        ...
        <div class="site-footer__legal">
            ...
            <p class="site-footer__copy">&copy; <?= $year ?> <?= e($site['brand_name']) ?> - Tous droits reserves.</p>
        </div>
